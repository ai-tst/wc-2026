    ...
    <details class="rules-note">
      ...
      <div class="rules-note__body">
        ...
        <div class="rules-note__group">
          ...
          <p class="rules-note__why">Исход и точный счёт теперь <b>суммируются</b> (никаких бонусов сверху — убрали, слишком путали). «Исход» в плей-офф — это кто прошёл дальше (хоть по пенальти). Точный счёт считается по основному + дополнительному времени, без серии пенальти. Ранние раунды берут массой матчей, а к финалу каждый матч жирнее.</p>
        </div>
      </div>
    </details>`;
}

    ...
    <details class="rules-note">
      ...
      <div class="rules-note__body">
        ...
        <div class="rules-note__group">
          ...
          <p class="rules-note__why">«Исход» в плей-офф — это кто прошёл дальше (с пенальти), точный счёт — счёт в основное время. Бонус идёт сверху базовых очков и растёт от раунда к раунду: ранние раунды берут массой матчей, а к финалу каждый матч жирнее.</p>
        </div>
      </div>
    </details>`;
}
